...
class CustomDPOTrainer(DPOTrainer):
    ...
    def concatenated_forward(
        ...
        print ('[concatenated_forward chosen_logps, rejected_logps, valid_length requires_grad]', chosen_logps.requires_grad, rejected_logps.requires_grad, chosen_length.requires_grad)
    ...
    def get_batch_loss_metrics(
        ...
        print ('[get_batch_loss_metrics losses, sft_loss requires_grad]', losses.requires_grad, sft_loss.requires_grad)
