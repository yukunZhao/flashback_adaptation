...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument):
    ...
    # zhaoyukun02 1.10 added
    pool_size: int = field(
        default=12,
        metadata={"help": "Size of the data pool in each group."},
    )
    group_nums: int = field(
        default=16,
        metadata={"help": "Number of groups to divide the dataset into."},
    )
    top_k_JL: int = field(
        default=2,
        metadata={"help": "Top-K Joint Learning."},
    )
    ...
    def __post_init__(self):
        ...
        self.use_ref_model = self.stage in ["dpo", "sft_regularization", "PACE", "JMT"]  and self.pref_loss not in ["orpo", "simpo"]
