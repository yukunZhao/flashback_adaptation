...
def convert_alpaca(
    ...
    # zhaoyukun 12.9 add group_id, has_label
    output = {
        "_prompt": prompt,
        "_response": response,
        ...
        "group_id" : example[dataset_attr.group_id] if dataset_attr.group_id and dataset_attr.group_id in example  else -1,
        "task_id" : example[dataset_attr.task_id] if dataset_attr.task_id and dataset_attr.task_id in example  else -1,
        "has_label" : example[dataset_attr.has_label] if dataset_attr.has_label and dataset_attr.has_label in example else 1,
        "input_embeds" : example[dataset_attr.input_embeds] if dataset_attr.input_embeds and dataset_attr.input_embeds in example else [],
    }
    return output
...
def align_dataset(
    ...
    #print ('[debug align_dataset remove_column_names]', column_names)
    kwargs = {}
