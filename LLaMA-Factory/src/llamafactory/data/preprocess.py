...
from .processors.supervised import (
    ...
    preprocess_anchor_supervised_dataset,
...
def get_preprocess_and_print_func(
    ...
    if stage == "pt":
        ...
        if data_args.packing:
            ...
            # zhaoyukun 12.9, preprocess_supervised_dataset -> preprocess_anchor_supervised_dataset
            preprocess_func = partial(
                preprocess_anchor_supervised_dataset,
                template=template,
                tokenizer=tokenizer,
        ...
        # preprocess_anchor_supervised_dataset, preprocess_unsupervised_dataset
        # print (f"[zhaoyukun preprocess] preprocess_unsupervised_dataset in get_preprocess_and_print_func")
        preprocess_func = partial(
